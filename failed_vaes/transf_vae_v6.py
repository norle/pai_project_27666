...
if model_path != None:
    ...
    model = TransformerAutoregressor(vocab_size, model_dim, num_heads, num_layers, dim_feedforward=1024, dropout=0.1, max_len=seq_length, latent_dim=latent_dim).to(device)
